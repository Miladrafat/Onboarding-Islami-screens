...
import 'package:islami/ImagesFile.dart';
...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  List<Map<String, String>> onboardingData = [
    {
      "islamiHeader": ImagesFile.islamiHeader,
      "image":ImagesFile.imageInCenter_1,
      "title": "Welcome To Islmi App",
      "desc":""
    },
    {
      "islamiHeader": ImagesFile.islamiHeader,
      "image":ImagesFile.imageInCenter_2,
      "title": "Welcome To Islami",
      "desc": "We Are Very Excited To Have You In Our Community"
    },
    {
      "islamiHeader": ImagesFile.islamiHeader,
      "image":ImagesFile.imageInCenter_3,
      "title": "Reading the Quran",
      "desc": "Read,and your Lord is the Most Generous"
    },
    {
      "islamiHeader": ImagesFile.islamiHeader,
      "image":ImagesFile.imageInCenter_4,
      "title": "Bearish",
      "desc": "Praise the name of your Lord, the Most High"
    },
    {
      "islamiHeader": ImagesFile.islamiHeader,
      "image":ImagesFile.imageInCenter_5,
                  ...
                  InkWell(
                    onTap: () {
                      if (currentIndex == onboardingData.length - 1) {
                       ...
                       Navigator.pushNamed(context,SebhaScreen.routeName);
